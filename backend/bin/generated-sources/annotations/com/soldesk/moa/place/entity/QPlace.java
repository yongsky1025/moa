...
public class QPlace extends EntityPathBase<Place> {
    ...
    public final NumberPath<Integer> maxReservationHour = createNumber("maxReservationHour", Integer.class);

    public final NumberPath<Integer> minReservationHour = createNumber("minReservationHour", Integer.class);

    public final StringPath name = createString("name");

    public final TimePath<java.time.LocalTime> openTime = createTime("openTime", java.time.LocalTime.class);

    public final ListPath<PlaceClosedDay, QPlaceClosedDay> placeClosedDays = this.<PlaceClosedDay, QPlaceClosedDay>createList("placeClosedDays", PlaceClosedDay.class, QPlaceClosedDay.class, PathInits.DIRECT2);
