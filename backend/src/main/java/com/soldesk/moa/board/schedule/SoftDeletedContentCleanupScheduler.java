...
public class SoftDeletedContentCleanupScheduler {
    ...
    // 매일 새벽 4시에 deleted=true 이고 30일 지난 board/post/reply/image를 물리 삭제
    @Transactional
    ...
    public void purgeSoftDeletedContent() {
        ...
        int deletedImages = imageRepository.hardDeleteSoftDeletedBefore(cutoff);
        ...
        if (unlinkedParents > 0 || deletedReplies > 0 || deletedImages > 0 || deletedPosts > 0 || deletedBoards > 0) {
            log.info("[CLEANUP] cutoff={}, unlinkedParents={}, replies={}, images={}, posts={}, boards={}",
                    cutoff, unlinkedParents, deletedReplies, deletedImages, deletedPosts, deletedBoards);
        }
    }
}
