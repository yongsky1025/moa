...
public interface SanctionRepository extends JpaRepository<Sanction, Long>, SearchSanctionRepository {
    ...
    @Query("""
            ...
            """)
    Optional<Sanction> findAutoSanctionByWarning(Long userId, SanctionState state, LocalDateTime warningCreatedAt);
    ...
    @Query("""
            ...
            """)
    boolean existsOtherActiveSanction(Long userId, Long excludeSanctionId);
}
