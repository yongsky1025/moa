...
public class FreePostRestController {
    ...
    public Long create(@RequestBody @Valid PostRequestDTO req,
        ...
        return postService.createGlobal(BoardType.FREE, userDetails.getUser().getUserId(), req);
    }
    ...
    public Long update(@PathVariable("postId") Long postId,
            ...
            @AuthenticationPrincipal CustomUserDetails userDetails) {
        return postService.updateFreeAsOwner(postId, userDetails.getUser().getUserId(), req);
    }
    ...
    public void delete(@PathVariable("postId") Long postId,
            @AuthenticationPrincipal CustomUserDetails userDetails) {
        postService.deleteFreeAsOwner(postId, userDetails.getUser().getUserId());
    }
}