...
public class CirclePostRestController {
    ...
    public Long create(@PathVariable("circleId") Long circleId,
        ...
        return postService.createCircle(circleId, boardId, userDetails.getUser().getUserId(), req);
    }
    ...
    public Long update(@PathVariable("circleId") Long circleId,
            ...
            @RequestBody @Valid PostRequestDTO req,
            @AuthenticationPrincipal CustomUserDetails userDetails) {
        return postService.updateCircleAsOwner(circleId, boardId, postId, userDetails.getUser().getUserId(), req);
    }
    ...
    public void delete(@PathVariable("circleId") Long circleId,
            ...
            @PathVariable("postId") Long postId,
            @AuthenticationPrincipal CustomUserDetails userDetails) {
        postService.deleteCircleAsOwner(circleId, boardId, postId, userDetails.getUser().getUserId());
    }
}