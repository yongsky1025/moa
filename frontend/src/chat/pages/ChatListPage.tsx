...
export default function ChatListPage() {
  ...
  return (
    <div style={styles.container} onClick={() => setContextMenu(null)}>
      ...
      {/* 우클릭 컨텍스트 메뉴 */}
      {contextMenu && (
        <div ref={menuRef} style={{ ...styles.ctxMenu, top: contextMenu.y, left: contextMenu.x }} onClick={(e) => e.stopPropagation()}>
        ...
        <div style={styles.modalOverlay} onClick={() => setRenaming(null)}>
          <div style={styles.modal} onClick={(e) => e.stopPropagation()}>
            ...
            <div style={styles.modalBtns}>
              ...
              <button style={styles.modalConfirm} onClick={handleRename}>
                변경
              </button>
            </div>
          </div>
