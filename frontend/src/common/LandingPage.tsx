...
export default function LandingPage() {
  ...
  return (
    <div
      data-moa-landing
      className="min-h-screen flex flex-col overflow-hidden bg-white"
    >
        ...
        <div className="relative z-10 mx-auto flex max-w-4xl flex-col items-center justify-center px-4 text-center">
          ...
          >
            <h1 className="moa-landing__f ont-pretendard mb-7 text-[34px] font-semibold leading-[1.04] tracking-[-0.035em] text-white md:text-[54px]">
              ...
              <br />
              <span className="moa-landing__fade-in moa-landing__fade-delay-2 mt-2 inline-block opacity-0 md:mt-3">
                같은 속도의 모임
              </span>
            </h1>
          </div>
      ...
      <section className="w-full bg-white px-4 py-20">
        <div className="mx-auto max-w-4xl">
          <h2 className="moa-landing__font-serif mb-6 text-center text-3xl font-semibold tracking-[-0.03em] text-gray-800 md:text-5xl">
            MOA란?
          </h2>
          <p className="mx-auto mb-12 max-w-3xl text-center text-base leading-8 text-gray-500 md:text-lg">
            MOA는 5축 에너지 프로필을 기반으로 당신의 현재 에너지 상태와 가장 잘
            맞는 소규모 모임을 추천하는 플랫폼입니다. 기존의 관심사 기반 매칭과
            달리, 사회적 상호작용, 상호작용 깊이, 활동 강도, 참여 부담, 구조화
            정도 등 다양한 차원을 고려하여 진짜로 당신에게 맞는 모임을
            찾아드립니다.
          </p>
          ...
          <div className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-5">
            {[
              ...
              <div
                key={index}
                className="moa-landing__font-serif rounded-lg border border-gray-200 bg-white p-6 transition-shadow hover:shadow-md"
              >
      ...
      <footer className="w-full border-t border-gray-200 bg-gray-50 px-4 py-8">
        <div className="mx-auto max-w-4xl text-center">
          <p className="text-sm text-gray-500">
            &copy; 2026 MOA. 조용한 교류, 에너지에 맞는 모임을 찾아보세요.
          </p>
        </div>
      </footer>
    </div>
