import { AdminPlacesProvider, useAdminPlaces } from "../context/AdminPlacesContext";
import AdminPlaceFilterBar from "../component/place/AdminPlaceFilterBar";
import AdminPlaceTable from "../component/place/AdminPlaceTable";

function Header() {
  const { data, refresh } = useAdminPlaces();
