...
const MENU_ITEMS: MenuItem[] = [
  ...
  { key: "users", label: "유저 관리", icon: "👥", path: "/admin/users" },
  {
    ...
    children: [
      ...
      {
        key: "circles-category",
        label: "카테고리 관리",
        path: "/admin/circles/category",
      },
    ],
  },
  {
    ...
    icon: "📋",
    children: [
      { key: "posts-all", label: "전체 게시글 관리", path: "/admin/posts" },
      {
        key: "posts-notices",
        label: "공지사항 관리",
        path: "/admin/posts/notices",
      },
    ],
  },
  {
    ...
    icon: "📍",
    children: [
      { key: "places-all", label: "전체 장소 관리", path: "/admin/places" },
      {
        key: "places-register",
        label: "신규 장소 등록",
        path: "/admin/places/register",
      },
    ],
  },
  {
...
export default function AdminSidebar() {
  ...
  const [openMenus, setOpenMenus] = useState<Set<string>>(
    new Set(["circles", "posts", "places", "reports", "logs"]),
  );
