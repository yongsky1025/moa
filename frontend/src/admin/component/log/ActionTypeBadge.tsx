...
const BADGE_CONFIG: Record<ActionType, { label: string; bg: string; color: string }> = {
  ...
  CLOSE:            { label: 'CLOSE',    bg: '#F1F5F9', color: '#334155' },
  RESTORE:          { label: 'RESTORE',  bg: '#DBEAFE', color: '#1E40AF' },
  SANCTION:         { label: 'SANCTION', bg: '#FEE2E2', color: '#7F1D1D' },
  CANCEL_SANCTION:  { label: 'CANCEL-S', bg: '#FEF9C3', color: '#713F12' },
  REPORT:           { label: 'REPORT',   bg: '#FFEDD5', color: '#9A3412' },
  RESOLVE_REPORT:   { label: 'RESOLVE',  bg: '#F0FDF4', color: '#14532D' },
  RESERVE:          { label: 'RESERVE',  bg: '#F3E8FF', color: '#6B21A8' },
  CANCEL_RESERVATION: { label: 'CANCEL-R', bg: '#FDF4FF', color: '#86198F' },
