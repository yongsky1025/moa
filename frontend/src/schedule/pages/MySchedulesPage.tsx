      ...
      <main style={{ maxWidth: 1200, margin: '0 auto', padding: '32px 20px 60px' }}>
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: 24 }}>
          <div>
            ...
            <h1 style={{ fontSize: 22, fontWeight: 800, color: '#111' }}>참석한 일정</h1>
          </div>
        </div>
          ...
          <div style={{ backgroundColor: 'white', borderRadius: 16, padding: 20, boxShadow: '0 2px 12px rgba(0,0,0,0.06)' }}>
            ...
            {loading ? (
              ...
              <div style={{ textAlign: 'center', padding: '40px 0', color: '#aaa' }}>
                <p style={{ fontSize: 14, marginBottom: 4 }}>이달 참석한 일정이 없습니다.</p>
              </div>
            ) : (
                ...
                {schedules.map(s => {
                  ...
                  return (
                    <div
                      ...
                      onMouseEnter={e => { if (s.circleId) e.currentTarget.style.backgroundColor = '#f0f4ff'; }}
