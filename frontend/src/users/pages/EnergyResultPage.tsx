  ...
  return (
    <div style={{ minHeight: "100vh", backgroundColor: "#f7f7f8" }}>
      ...
      <main style={{ maxWidth: 480, margin: "0 auto", padding: "40px 20px 80px" }}>
        <h1 style={{ fontSize: 22, fontWeight: 900, color: "#111", marginBottom: 24 }}>내 에너지 결과</h1>
        ...
        {!loading && result && (
          ...
          >
            <div style={{ textAlign: "center", marginBottom: 24 }}>
              ...
              <h2 style={{ fontSize: 24, fontWeight: 800, color: "#111", marginBottom: 12 }}>{result.energyTypeName}</h2>
              <p style={{ fontSize: 14, color: "#555", lineHeight: 1.6 }}>{result.energyTypeDescription}</p>
            </div>
            ...
            {result.recommendedCategories && (
              ...
              >
                <p style={{ fontSize: 12, fontWeight: 600, color: "#888", marginBottom: 8 }}>추천 카테고리</p>
            ...
            >
              <p style={{ fontSize: 12, fontWeight: 600, color: "#888", marginBottom: 12 }}>나의 에너지 프로필</p>
              {[
